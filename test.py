...
if temp < 10:
    print("на улице довольно холодно. оденьтесь потеплее, и не забудьте надеть термобелье под основной одеждой. Держите ноги в тепле, выберите обувь с соответсвующим температурным режимом ")
elif temp < 20:
